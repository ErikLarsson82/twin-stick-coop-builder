...
module.exports = function (world, map, offset) {
  ...
  new Array(data.body.length).fill().forEach(function(v, i) {
  ...
  for (var i = 0; i < data.joint.length; i++) {
    ...
    if (jointData.type === 'revolute') {
      ...
      */
      var bodyA = jointData.bodyA
      var bodyB = jointData.bodyB
      ...
      */
      ...
      jointDef.bodyA = jointData.bodyA //mapObjects[]
      jointDef.bodyB = jointData.bodyB //mapObjects[]
